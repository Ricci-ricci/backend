...
import { addToCartSchema, getCartSchema, updateCartItemSchema, removeCartItemSchema, clearCartSchema, } from "../schemas/cart.schema.js";
...
cartRoute.put("/items/:itemId", authenticate, validate(updateCartItemSchema), updateCartItem);
// Supprimer un item du panier (nécessite authentification)
cartRoute.delete("/items/:itemId", authenticate, validate(removeCartItemSchema), removeCartItem);
// Vider le panier d'un utilisateur (nécessite authentification)
cartRoute.delete("/:userId", authenticate, validate(clearCartSchema), clearCart);
